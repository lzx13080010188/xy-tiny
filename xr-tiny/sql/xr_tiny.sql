...
CREATE TABLE `sys_log` (
  ...
  `REGISTER_NAME` varchar(500) DEFAULT NULL,
  `USER_ID` int(11) DEFAULT NULL,
  `USER_NAME` varchar(500) DEFAULT NULL,
  `PERATION` varchar(500) DEFAULT NULL,
  `METHOD` varchar(500) DEFAULT NULL,
  `PARAMS` varchar(500) DEFAULT NULL,
  `IP` varchar(500) DEFAULT NULL,
  `CREATE_DATE` datetime DEFAULT NULL,
  `OPERATE_RESULT` varchar(500) DEFAULT NULL,
  `ABNORMITY` varchar(500) DEFAULT NULL,
  PRIMARY KEY (`ID`)
...
INSERT INTO `ums_admin` VALUES (3, 'admin', '$2a$10$rSLkDKvVEDIDGscRdAsfXehsC63ZWYGD1Xw6XEdSzJfbNAowjuEdq', 'http://macro-oss.oss-cn-shenzhen.aliyuncs.com/mall/images/20180607/timg.jpg', 'admin@163.com', '系统管理员', '系统管理员', '2018-10-08 13:32:47', '2019-04-20 12:45:16', 1);
...
INSERT INTO `ums_admin_login_log` VALUES (287, 10, '2022-02-13 08:09:11', '0:0:0:0:0:0:0:1', NULL, NULL);
COMMIT;
